...
- `.squad/decisions/inbox/heisenberg-orleans-evaluation.md` — Grain Types (tree notation → `graph TD`)
...
- `.squad/decisions/inbox/heisenberg-orleans-evaluation.md` — Grain Interactions (improved labels)
...
**Decision written:** `.squad/decisions/inbox/badger-diagram-standards.md`
