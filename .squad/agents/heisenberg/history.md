...
- **Written to:** `.squad/decisions/inbox/heisenberg-orleans-evaluation.md`
...
- **Key file paths:**
  - `.squad/log/2026-02-12-retrospective.md` — full retrospective with root cause analysis and action items
  - `.squad/decisions/inbox/heisenberg-retro-2026-02-12.md` — retro decisions for team
