...
All 4 decision inbox files merged into `.squad/decisions.md`:
...
1. **Git commit** — Stage `.squad/` and commit with message "Sprint 9 complete: engine wiring, smoke tests, DI registration [skip ci]"
2. **Mark last-run** — Create `.squad/agents/scribe/last-run.md` with completion timestamp and summary
