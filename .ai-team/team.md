...
> Modernizing .NET Terrarium 2.0 — the classic peer-to-peer creature ecosystem game
...
|------|------|---------|--------|
| Heisenberg | Lead / Architect | `.ai-team/agents/heisenberg/charter.md` | ✅ Active |
| Jesse | Client Dev | `.ai-team/agents/jesse/charter.md` | ✅ Active |
